    ...
    <div id="container"> <!-- ヘッダー -->
        ...
        <main id="new-main"><!-- MV -->
            ...
            <section class="introduce top-introduce heading"> <!-- タイトル -->
                ...
                <div class="introduce-inner inner"> <!-- テキスト＋グラフ部分 -->
                    <div class="introduce-text-wrapper">
                        <div class="introduce-text-flexbox">
                    ...
                    <div class="introduce-type">
                        <h4 class="introduce-type_title">対応業種</h4>
                        <ul class="introduce-type_list">
                            <li>内装</li>
                            <li>原状回復</li>
                            <li>設計・デザイン</li>
                            <li>解体</li>
                    ...
                    <div class="introduce-campany">
                        <h3 class="introduce-campany_title"> 建築・建設業界での<br class="u-mobile">導入社数は<span
