                          ...
                          <div class="tab-pane active">
                            <form class="simple_form form-horizontal margin-top-30" id="edit_user_272951" enctype="multipart/form-data" action="/account/edit_company_profile/" accept-charset="UTF-8" method="post">
                              ...
                              <div class="form-group select required user_profile_department">
                                <label class="col-sm-3 control-label select required" for="user_profile_attributes_department">部署 / 役職</label>
                                <div class="col-sm-8 display-flex-sm">
                                  <spin class=" m-l-20">
                                    <select class="form-control select required w-300px" required="required" aria-required="true" name="department" id="department">
                                  ...
                                  <spin class="m-l-35">
                                    <select class="form-control select required w-300px" required="required" aria-required="true" name="job_title" id="job_title">
                                      <option value="">選択してください</option>
                              ...
                              <div class="form-group select required user_corporation_type_of_business">
                                <label class="col-sm-3 control-label select required" for="user_corporation_attributes_type_of_business">業種</label>
                                <div class="col-sm-8 flex m-l-20">
                              ...
                              <div class="form-group select required user_corporation_scale">
                                <label class="col-sm-3 control-label select required" for="user_corporation_attributes_scale">従業員規模</label>
                                <div class="col-sm-8 flex m-l-20">
