      ...
      <div class="guide-common-wrapper">
        <div class="container-lg">
          ...
          <div class="guide-common-searchWrapper text-center">
            <div id="guide-search-form" class="guide-search-formBlock" accept-charset="UTF-8" data-remote="true"
              method="get">
              <input placeholder="ガイド名・カテゴリー名 [例：経費精算システム選び方ガイド、経費精算]" class="guide-search-formBlock__inputElement"
          ...
          <div class="row" id="common-guide-list">
            ...
            <div class="col-sm-6 col-lg-3 text-center">
              <label class="checkbox guide-img-thumbnail" for="{{$c_guide->id}}">
                <div class="guide-img-thumbnail-wrapper">
                  <div class="guide-img">
                    <img alt="{{$c_guide->title}}" src="{{ asset($c_guide->image) }}" data-xblocker="passed"
                      style="visibility: visible;" width="100%">
                    <div class="guide-checkbox">
                      <div class="checker">
                        <span class="checked">
                          <input class="checkbox-input" id="{{$c_guide->id}}" name="category_document" type="checkbox"
                            value="{{$c_guide->id}}" style="display: inline-block;">
                        </span>
                      </div>
                      <span class="lever-sm"></span>
                    </div>
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        response.map(guide => {
          ...
          guide_list +=
            `<input  class="checkbox-input" id="${guide.id}" name="category_document" type="checkbox" value="${guide.id}" style="display: inline-block;">\n`;
          guide_list += '</span>\n</div>\n';
