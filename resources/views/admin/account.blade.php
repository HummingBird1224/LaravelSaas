              ...
              <div id="table-wrapper" style="overflow: auto; width: 100%;">
                <table class="table table-bordered" style="width: 100%;" id="item-table">
                  ...
                  <tbody id="item-table-body">
                    ...
                    <tr data-id={{ $user->id }}>
                      <td>
                        <span data-id={{ $user->id }} data-bs-toggle="modal" data-bs-target="#confirmModal">
                      ...
                      <td rowspan="1" colspan="1">
                        <div class="form-group">
                          <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input permission"
                              id={{"customSwitch".$user->id}} @if($user['is_permitted']) checked @endif>
