                  ...
                  <div class="tabbable-custom">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active">
						@if (isset($user))
                        <form class="simple_form form-horizontal margin-top-30"
                          enctype="multipart/form-data" action="{{ route('change_user_profile') }}" accept-charset="UTF-8"
                          method="post">
                          @csrf
                              ...
                              <div class="col-sm-7 display-flex-sm">
                                <span class="m-l-20">
                                  <div class="form-group string required user_profile_last_name_kana">
                                    <input class="form-control string required form-control w-50px inline-block"
                                      aria-required="true" placeholder="セイ" type="text"
                                ...
                                <span class="m-l-35">
                                  <div class="form-group string required user_profile_first_name_kana">
                                    <input class="form-control string required form-control w-50px inline-block"
                                      aria-required="true" placeholder="メイ" type="text"
                          ...
                          <div class="form-group tel required user_profile_phone row">
                            <label class="col-sm-3 control-label tel required"
                              for="user_profile_attributes_phone">電話番号（必須）</label>
                            <div class="col-sm-8 m-l-20">
                              <input class="form-control string tel required w-300px"
						...
						@else
						<form class="simple_form form-horizontal margin-top-30"
                          enctype="multipart/form-data" action="{{ route('add_user_profile') }}" accept-charset="UTF-8"
                          method="post">
                          @csrf
                          <input type="hidden" name="authenticity_token"
                            value="LgeuzujFUlMVxzWPs26P9g8koraSjDZKRE+USK717pQ40HiHN2bvAzWCdUipB063Np91mxyCPC7frPCgdvX4rg==">
							  ...
							  <div class="col-sm-7 display-flex-sm">
                                <span class="m-l-20 ">
                                  <div class="form-group string required user_profile_last_name">
                                    <input class="form-control string required form-control w-50px inline-block"
                                      required="required" aria-required="true" placeholder="姓" type="text"
                                      name="email" id="user_profile_attributes_last_name">
                                  </div>
                                </span>
                              </div>
                            </div>
                              ...
                              <div class="col-sm-7 display-flex-sm">
                                <span class="m-l-20 ">
                                  <div class="form-group string required user_profile_last_name">
                                    <input class="form-control string required form-control w-50px inline-block"
                                      required="required" aria-required="true" placeholder="姓" type="text"
                                      name="first_name" id="user_profile_attributes_last_name">
                                  </div>
                                </span>
                                <span class="m-l-35">
                                  <div class="form-group string required user_profile_first_name">
                                    <input class="form-control string required form-control w-50px inline-block"
                                      required="required" aria-required="true" placeholder="名" type="text"
                                      name="last_name" id="user_profile_attributes_first_name">
                                  </div>
                                </span>
                              </div>
                            </div>
                          ...
                          <div class="form-group tel required user_profile_phone row">
                            ...
                            <div class="col-sm-8 m-l-20">
                              <input class="form-control string tel required w-300px"
                                title="電話番号はハイフンなしで入力してください" required="required" aria-required="true"
                                placeholder="03xxxxxxxx（ハイフンなし）" type="tel" name="phone_number"
                                id="user_profile_attributes_phone">
                            </div>
                          </div>
                          ...
                          <div class="middle-button text-center m-t-15">
                            <button type="submit" value="送信" data-disable-with="送信中..."
                              class="green-button button btn-raised btn-orange-md col-xs-offset-3 track-regist-db"
							>
							  	送信
							</button>
