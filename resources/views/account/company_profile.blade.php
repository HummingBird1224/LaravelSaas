                      ...
                      <div class="tab-pane active">
                        <form class="simple_form form-horizontal margin-top-30" id="edit_user_272951" enctype="multipart/form-data" action="/account/edit_company_profile/" accept-charset="UTF-8" method="post">
                          ...
                          <div class="form-group  user_profile_phone row">
                            <label class="col-sm-3 control-label tel required" for="user_profile_attributes_phone">会社名（必須）</label>
                            <div class="col-sm-8 m-l-20">
                              <input 
                                class="form-control string tel required w-300px"  
                                required="required" 
                                aria-required="true" 
                          ...
                          <div class="form-group select required user_corporation_scale">
                            ...
                            <div class="col-sm-8 flex m-l-20">
                              <select class="form-control select required w-300px" required="required" aria-required="true" name="employee_number" id="user_corporation_attributes_scale">
                          ...
                          <div class="form-group select required user_corporation_type_of_business">
                            ...
                            <div class="col-sm-8 flex m-l-20">
                              <select class="form-control select required w-300px" required="required" aria-required="true" name="industry" id="user_corporation_attributes_type_of_business">
                                <option value="">選択してください</option>
                              ...
                              <div class="fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail" style="max-width: 180px; max-height: 180px;">
                                  @if($isCompany&&$company->logo)
                                    <img width="170" height="160" src="{{ asset($company->logo) }}" data-xblocker="passed" style="visibility: visible;" id="logo_preview">
                                  @else 
                          ...
                          <div class="form-group string required user_corporation_company_name">
                            <label class="col-sm-3 control-label string required" for="user_corporation_attributes_company_name">代表者名</label>
                            <div class="col-sm-8 flex m-l-20">
                              <input 
                          ...
                          <div class="form-group string required user_corporation_company_name">
                            <label class="col-sm-3 control-label string required" for="user_corporation_attributes_company_name">電話番号</label>
                            <div class="col-sm-8 flex m-l-20">
                              <input 
                                class="form-control string required w-300px" 
                                required="required" 
                                aria-required="true" 
                                placeholder="03xxxxxxxx（ハイフンなし）" 
                                type="text" 
                                name="phone_number" 
                          ...
                          <div class="form-group string required user_corporation_company_name">
                            <label class="col-sm-3 control-label string required" for="user_corporation_attributes_company_name">設立年</label>
                            <div class="col-sm-8 flex m-l-20">
                              <input 
                                class="form-control string required w-300px" 
                                required="required" 
                          ...
                          <div class="form-group string required user_corporation_company_name">
                            <label class="col-sm-3 control-label string required" for="user_corporation_attributes_company_name">設立月</label>
                            <div class="col-sm-8 flex m-l-20">
                              <input 
                                class="form-control string required w-300px" 
                                max="12" min="1" 
                          ...
                          <div class="form-group string required user_corporation_company_name">
                            <label class="col-sm-3 control-label string required" for="user_corporation_attributes_company_name">資本金</label>
                            <div class="col-sm-8 flex m-l-20">
                              <input 
                                class="form-control string required w-300px" 
                                required="required" 
                          ...
                          <div class="form-group string required user_corporation_company_name">
                            <label class="col-sm-3 control-label string required" for="user_corporation_attributes_company_name">会社URL</label>
                            <div class="col-sm-8 flex m-l-20">
                              <input 
                                class="form-control string required w-300px" 
                                required="required" 
                                aria-required="true" 
                                placeholder="http://xxx.jp" 
                                type="text" 
                                name="company_url" 
                          ...
                          <div class="orange-button text-center m-t-15">
                            <button 
                              ...
                              name="commit" 
                              value="更新する" 
                              class="orange-button-btn btn-raised btn-orange-md" 
