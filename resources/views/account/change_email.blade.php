                  ...
                  <div class="tabbable-custom">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane active">
                        ...
                        @endif
                        {{ isset($error) ? $error : '' }}
                        <form id="formAuthentication" class="mb-3" method="POST" action="/account/edit_email" onsubmit="onSubmit(event)">
                          @csrf	
                          <!-- <div class="mb-2">
                          ...
                          <div class="form-group form-password-toggle row">
                            ...
                            <div class="col-md-4 m-l-20">
                              <div class="form-group string required user_profile_last_name">
                                <input 
                                  class="form-control string required form-control w-50px inline-block" 
                                  required="required" 
                                  aria-required="true"  
                                  type="password" 
                                  name="password" 
                          ...
                          <div class="orange-button text-center m-t-15">
                            <button type="submit" name="commit" value="変更する" class="orange-button-btn btn-raised btn-orange-md col-xs-offset-3 track-regist-db" data-disable-with="送信中...">
                              変更する
                            </button>
                          </div>
                        </form>
