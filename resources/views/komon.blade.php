...
<head> <!-- Google Tag Manager -->
    ...
    <link rel="alternate" type="application/rss+xml" title="【ツクノビ公式】建築建設特化の営業代行｜丸投げで2000社に営業&amp;売上増 &raquo; フィード"
        href="https://tsukunobi.com/feed" />
    <link rel="alternate" type="application/rss+xml" title="【ツクノビ公式】建築建設特化の営業代行｜丸投げで2000社に営業&amp;売上増 &raquo; コメントフィード"
        href="https://tsukunobi.com/comments/feed" />
    ...
    <style id='sango_theme_gutenberg-style-inline-css' type='text/css'>
        ...
        .emboss .wp-block-button__link {
            color: rgba(0, 0, 0, .4);
            font-weight: 700;
            text-shadow: 1.5px 1.5px 1.5px hsla(0, 0%, 100%, .5)
        }
        ...
        .text3d .wp-block-button__link {
            ...
            font-weight: 700;
            letter-spacing: 1px;
            text-shadow: -.9px -.5px hsla(0, 0%, 100%, .6), 1px 1.2px rgba(0, 0, 0, .35)
        }
        ...
        #inner-content [class*=is-style-box]>.wp-block-group__inner-container>:first-child .sgb-heading__inner,
        ...
        .wp-block-sgb-posts .splide__pagination .splide__pagination__page.is-active {
            background: #333
        }
        ...
        .sgb-e-link--horizontal .sgb-e-link__image {
            border-right: 1px solid rgba(14, 11, 72, .08);
            height: 150px;
            max-width: 230px
        }
        ...
        .sgb-e-link--vertical .sgb-e-link__image {
            border-bottom: 1px solid rgba(14, 11, 72, .08)
        }
        ...
        .sgb-full-bg .sgb-full-bg__content {
            margin: 0 auto;
            max-width: calc(var(--wp--custom--wrap--max-width) + var(--wp--custom--wrap--mobile--padding)*2);
        ...
        .sgb-full-bg--first-no-margin .sgb-full-bg__content>:first-child>.sgb-heading>.sgb-heading__inner,
        .sgb-full-bg--first-no-margin .sgb-full-bg__content>[id^=sgb-css-id]:first-child>*,
        .sgb-full-bg--first-no-margin .sgb-full-bg__content>[id^=sgb-css-id]:first-child>.sgb-heading>.sgb-heading__inner {
            margin-top: 0 !important
        }
        ...
        .widget.my_profile .wp-block-social-link.is-style-default .wp-block-social-link-anchor {
            height: 40px;
            width: 40px
        }

        .widget.my_profile .wp-block-social-link.is-style-default .wp-block-social-link-anchor svg {
            height: 100%;
            width: 100%
        }
        ...
        .sgb-toc-dialog {
            -webkit-animation: sgb-toc-show .3s;
            animation: sgb-toc-show .3s;
        ...
        .sgb-toc-dialog__header {
            ...
            background-color: rgba(233, 237, 242, .333);
            left: 0;
            padding: 20px 30px;
            position: -webkit-sticky;
            position: sticky;
        ...
        .sgb-footer__content {
            ...
            max-width: calc(var(--wp--custom--wrap--content-width) + var(--wp--custom--wrap--mobile--padding)*2) !important;
        ...
        .sgb-header {
            background-color: var(--wp--preset--color--sango-main);
            box-shadow: 0 0 45px rgba(0, 12, 66, .15);
            padding-left: var(--wp--custom--wrap--mobile--padding);
            padding-right: var(--wp--custom--wrap--mobile--padding);
            position: relative
        }
        ...
        .sgb-header .wp-block-sgb-header-navigation .wp-block-navigation__container>.wp-block-navigation-item .wp-block-navigation__submenu-icon {
            display: none
        }

        .sgb-header .wp-block-sgb-header-navigation .wp-block-navigation__container>.wp-block-navigation-item i {
            opacity: .7;
            padding-right: 2px
        }
        ...
        .sgb-header .sgb-header__mobile-nav ul {
            -webkit-overflow-scrolling: touch;
            -webkit-animation: RightToLeft 2s cubic-bezier(.24, .56, .47, .91) 0s 1 normal;
            animation: RightToLeft 2s cubic-bezier(.24, .56, .47, .91) 0s 1 normal;
            border: none;
            flex-wrap: nowrap;
            gap: 1em;
        ...
        @media screen and (min-width:769px) {
            ...
            .sgb-header .wp-block-sgb-header-navigation .wp-block-navigation__submenu-container {
            ...
            .sgb-header .wp-block-sgb-header-navigation .wp-block-navigation__submenu-container li {
                border-bottom: 1px solid #7b7b7b;
                display: block
            }

            .sgb-header .wp-block-sgb-header-navigation .wp-block-navigation__submenu-container a {
            ...
            .sgb-header .wp-block-sgb-header-navigation .wp-block-navigation__submenu-container a:hover {
                background-color: gray
            }
        }
        ...
        .wp-block-sgb-header-mobile-navigation .sgb-header__mobile-nav .wp-block-navigation-submenu__toggle {
            display: none
        }
        ...
        :root {
            --sgb-main-color: #2a375e;
            --sgb-pastel-color: #eeeeee;
            --sgb-accent-color: #ffb36b;
            --sgb-widget-title-color: #000000;
            --sgb-widget-title-bg-color: #ffffff;
            --sgb-bg-color: #eaedf2;
    ...
    <link rel='stylesheet' id='sng-fontawesome-css'
        href='https://tsukunobi.com/sys/wp-content/themes/sango-theme/library/css/fa-sango.css' type='text/css'
        media='all' />
    <link rel='stylesheet' id='wp-block-library-css'
        href='https://tsukunobi.com/sys/wp-includes/css/dist/block-library/style.min.css?ver=6.2.2' type='text/css'
        media='all' />
    <link rel='stylesheet' id='wp-components-css'
        href='https://tsukunobi.com/sys/wp-includes/css/dist/components/style.min.css?ver=6.2.2' type='text/css'
        media='all' />
    <link rel='stylesheet' id='wp-block-editor-css'
        href='https://tsukunobi.com/sys/wp-includes/css/dist/block-editor/style.min.css?ver=6.2.2' type='text/css'
        media='all' />
    <link rel='stylesheet' id='wp-nux-css'
        href='https://tsukunobi.com/sys/wp-includes/css/dist/nux/style.min.css?ver=6.2.2' type='text/css' media='all' />
    <link rel='stylesheet' id='wp-reusable-blocks-css'
        href='https://tsukunobi.com/sys/wp-includes/css/dist/reusable-blocks/style.min.css?ver=6.2.2' type='text/css'
        media='all' />
    <link rel='stylesheet' id='wp-editor-css'
        href='https://tsukunobi.com/sys/wp-includes/css/dist/editor/style.min.css?ver=6.2.2' type='text/css'
        media='all' />
    <link rel='stylesheet' id='sticky_block-css-css'
        href='https://tsukunobi.com/sys/wp-content/plugins/sticky-block/dist/blocks.style.build.css' type='text/css'
        media='all' />
    <style id='global-styles-inline-css' type='text/css'>
        body {
            ...
            --wp--preset--color--custom-textcolor-1: #2a375e;
        ...
        .has-custom-textcolor-1-color {
            color: var(--wp--preset--color--custom-textcolor-1) !important;
        }
        ...
        .has-custom-textcolor-1-background-color {
            background-color: var(--wp--preset--color--custom-textcolor-1) !important;
        }
        ...
        .has-custom-textcolor-1-border-color {
            border-color: var(--wp--preset--color--custom-textcolor-1) !important;
        }
    ...
    <link rel='stylesheet' id='contact-form-7-css'
        href='https://tsukunobi.com/sys/wp-content/plugins/contact-form-7/includes/css/styles.css' type='text/css'
        media='all' />
    <link rel='stylesheet' id='uagb-slick-css-css'
        href='https://tsukunobi.com/sys/wp-content/plugins/ultimate-addons-for-gutenberg/assets/css/slick.min.css'
        type='text/css' media='all' />
    <link rel='stylesheet' id='uag-style-3673-css'
        href='https://tsukunobi.com/sys/wp-content/uploads/uag-plugin/assets/4000/uag-css-3673-1686615061.css'
        type='text/css' media='all' />
    <link rel='stylesheet' id='child-style-css'
        href='https://tsukunobi.com/sys/wp-content/themes/sango-theme-child/style.css' type='text/css' media='all' />
    <script type='text/javascript' src='https://tsukunobi.com/sys/wp-includes/js/jquery/jquery.min.js?ver=3.6.4'
        id='jquery-core-js'></script>
    <script type='text/javascript' src='https://tsukunobi.com/sys/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.0'
        id='jquery-migrate-js'></script>
    <link rel="https://api.w.org/" href="https://tsukunobi.com/wp-json/" />
    <link rel="alternate" type="application/json" href="https://tsukunobi.com/wp-json/wp/v2/pages/3673" />
    <link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://tsukunobi.com/sys/xmlrpc.php?rsd" />
    <link rel="canonical" href="https://tsukunobi.com/" />
    <link rel='shortlink' href='https://tsukunobi.com/' />
    <link rel="alternate" type="application/json+oembed"
        href="https://tsukunobi.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftsukunobi.com%2F" />
    <link rel="alternate" type="text/xml+oembed"
        href="https://tsukunobi.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ftsukunobi.com%2F&#038;format=xml" />
    <meta name="description"
        content="建築・建設業界特化の営業代行サービス【ツクノビ】の公式サイトです。月間2000社の営業活動を御社の代わり実施。【導入社数は250社以上、成果がなければ全額返金】営業戦略について無料提案いたします。業界特化型営業サポートでビジネスを加速させましょう。お気軽にお問い合わせください。" />
    <meta property="og:title" content="【ツクノビ公式】建築建設特化の営業代行｜丸投げで2000社に営業&amp;売上増｜営業戦略からアポ獲得まで支援いたします" />
    <meta property="og:description"
        content="建築・建設業界特化の営業代行サービス【ツクノビ】の公式サイトです。月間2000社の営業活動を御社の代わり実施。【導入社数は250社以上、成果がなければ全額返金】営業戦略について無料提案いたします。業界特化型営業サポートでビジネスを加速させましょう。お気軽にお問い合わせください。" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://tsukunobi.com/" />
    <meta property="og:image"
        content="https://tsukunobi.com/sys/wp-content/uploads/2023/02/48abf170702debeccf3969e432c8ac14-1024x619.png" />
    <meta name="thumbnail"
        content="https://tsukunobi.com/sys/wp-content/uploads/2023/02/48abf170702debeccf3969e432c8ac14-1024x619.png" />
    <meta property="og:site_name" content="【ツクノビ公式】建築建設特化の営業代行｜丸投げで2000社に営業&amp;売上増" />
    ...
    <link rel="icon"
        href="https://tsukunobi.com/sys/wp-content/uploads/2023/01/26e78d1e-2a40-41d2-9b93-7598e1166d52.png"
        sizes="32x32" />
    <link rel="icon"
        href="https://tsukunobi.com/sys/wp-content/uploads/2023/01/26e78d1e-2a40-41d2-9b93-7598e1166d52.png"
        sizes="192x192" />
    ...
    <meta name="msapplication-TileImage"
        content="https://tsukunobi.com/sys/wp-content/uploads/2023/01/26e78d1e-2a40-41d2-9b93-7598e1166d52.png" />
    <style type="text/css" id="wp-custom-css">
        ...
        @media (min-width: 978px) {
            .elementor-4285 .elementor-element.elementor-element-e69f9ae {
                --width: 340px;
            }
        }
        ...
        .tag_single span.tags {
            background: #eeeeee;
            border-radius: 8px;
            color: #333;
            font-family: var(--s-font-bface012);
            font-size: 16px;
            font-weight: 400;
            height: auto;
            margin: 0px 4px 0px;
        ...
        .log_content h3 {
            border-bottom: 0px solid #257bc5;
            border-left: 5px solid #257bc5;
            border-right: 0px solid #257bc5;
            border-top: 0px solid #257bc5;
            font-size: 24px;
            line-height: 2;
        ...
        div .call-form-sticky {
            align-content: flex-start;
            align-items: flex-start;
            background: rgba(227, 246, 245, 0.92);
            border-bottom: 1px solid rgba(42, 55, 94, 0.48);
            border-left: 1px solid rgba(42, 55, 94, 0.48);
            border-radius: 16px;
            border-right: 1px solid rgba(42, 55, 94, 0.48);
            border-top: 1px solid rgba(42, 55, 94, 0.48);
            bottom: auto;
            flex: none;
            justify-content: center;
            left: auto;
        ...
        top_lp-cap-s {
            ...
            line-height: 1.4em;
            text-decoration: none solid rgb(42, 55, 94);
            word-spacing: 1px;
            /* Color & Background */
        ...
        .top_lp-cap-m {
            font-size: clamp(1.125rem, 0.214rem + 2.917vw, 2rem);
            font-weight: 900;
            line-height: 1.2;
            text-shadow: 3px 3px#2A375E;
            padding: 6px;
            margin: 0 0 12px 0;
            color: #fff;
        }
        ...
        .top_lp-cap-l1 {
            font-size: clamp(1.375rem, 0.203rem + 3.75vw, 2.5rem);
            font-weight: 900;
            text-shadow: 3px 3px#2A375E;
            line-height: 1.2;
            padding: 10px;
        ...
        .top_lp-cap-l2 {
            font-size: clamp(2.25rem, 1.208rem + 3.333vw, 3.25rem);
            font-weight: 900;
            text-shadow: 3px 3px #2a375e;
            line-height: 1.2;
            padding: 10px;
        ...
        p.small-maru-label-main {
            border-radius: 40px !important;
            background-color: #257bc5 !important;
            color: #fff;
            display: inline-block;
            line-height: 1.1;
            margin: 0 6px;
        ...
        .top_cover {
            ...
            background-image: url(http://tsukunobi.local/wp-content/uploads/2023/02/dc1cf15248e71432ea81f5ea48ea4a86-940x627.jpg);
            background-size: cover;
            display: flex;
        ...
        div.tsukunobi_form p {
            margin-bottom: 0px;
        }

        div.tsukunobi_form input.wpcf7-submit {
            background: #257bc5;
            border-radius: 4px;
            border: none;
        ...
        div.web_form input.wpcf7-submit {
        ...
        div.web_form2 input.wpcf7-submit {
            font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;
            margin: 0;
            cursor: pointer;
            display: inline-block;
        ...
        div.komon_form input.wpcf7-submit {
            background: rgb(186, 149, 1);
            border-radius: 4px;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
            color: #fff;
            font-size: 15px;
        ...
        div.komon_form2 input.wpcf7-submit {
            background: #111111;
            border-radius: 4px;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
            color: #fff;
        ...
        div.call-form-sticky input.wpcf7-submit {
            background: #ffd803;
            border-radius: 4px;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
            justify-content: center;
        ...
        div.call-form input.wpcf7-submit {
            background: #ffd803;
            border-radius: 4px;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
            justify-content: center;
        ...
        div.net-form2-sticky input.wpcf7-submit {
            background: #ffd803;
            border-radius: 4px;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
            justify-content: center;
        ...
        div.net-form2 input.wpcf7-submit {
            background: #ffd803;
            border-radius: 4px;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
            justify-content: center;
        ...
        div.net_form input.wpcf7-submit {
            font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;
            margin: 0;
            cursor: pointer;
            display: inline-block;
        ...
        div.marke_form input.wpcf7-submit {
            font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;
            margin: 0;
            cursor: pointer;
            display: inline-block;
        ...
        .servicer_form p:nth-child(2) span span+span {
            display: block;
        }

        div.servicer_form p input {
            background: #ffffff;
            border-bottom: 1px solid #eeeeee;
            border-left: 1px solid #eeeeee;
            border-radius: 4px;
        ...
        div.servicer_form p:nth-child(3) input.wpcf7-submit {
            background: #257bc5;
            border-radius: 4px;
            border: none;
            box-shadow: 0px 0px 0px 0px rgb(0 0 0 / 20%);
        ...
        @media screen and (max-width: 979px) {
            ...
            #sgb-css-id-4 .sd[data-s-b4fa493b-20dd-422e-b7b7-3740f051a085] {
                display: none !important;
            }

            #sgb-css-id-4 .sd[data-s-445b1415-9917-470e-be45-27a7a19fd24f] {
                white-space: nowrap;
            }

            #sgb-css-id-4 .sd[data-s-d59f5005-4a4b-4df1-bb8d-76884b9f6c19] {
            ...
            #masthead .elementor-hidden-desktop.top_elements2.wp-block-column:nth-child(1) {
                width: 40%;
            }

            #masthead .elementor-hidden-desktop.top_elements2.wp-block-column:nth-child(2).elementor-element-19454eb {
                width: 55%;
            }

            .elementor-element-b2b3812c {
                display: flex !important;
                flex-wrap: no-wrap !important;
            }

            .elementor-element-9f4fe43 {
                width: 40%;
            }

            .elementor-element-19454eb {
                width: 55%;
            }
            ...
            .top_elements2.wp-block-column:nth-child(1) img {
                width: 200px;
            }

            .top_elements2.wp-block-column:nth-child(n + 2) {
                display: none;
            }
            ...
            /*マーケ*/
            .elementor-1418 .elementor-element.elementor-element-f9669d9 {
                margin-top: -50px !important;
            }

            /*ネット*/
            .elementor-4950 .elementor-element.elementor-element-e69f9ae.e-con {
                z-index: 100;
            }

            .elementor-4950 .elementor-element.elementor-element-f9669d9 {
                margin-top: -50px !important;
                z-index: 100;
            }

            /*ウエブ*/
            .elementor-906 .elementor-element.elementor-element-f9669d9 {
                margin-top: -70px !important;
            }

            /*-コール*/
            .elementor-1405 .elementor-element.elementor-element-f9669d9 {
                margin-top: -30px !important;
            }

            /*顧問*/
            .elementor-1425 .elementor-element.elementor-element-7ccc544 {
                --width: 45%;
            }

            .elementor-1425 .elementor-element.elementor-element-614736d {
                --width: 45%;
            }
        }
    ...
    <style>
        ...
        @media screen and (max-width:600px){ #sgb-css-id-4 .sd[data-s-bde702ff-41e9-492d-ac8b-8e4521015809] {
            display: flex;
            flex: none;
            height: auto !important;
    ...
    <style>
        @media screen and (min-width: 768px) {
            .top-mv {
                background-image: url("{{ asset('assets/img/tsukubnobi/komon/PC/img/fv_back.png') }}");
...
<body
    ...
    <div id="container"> <!-- ヘッダー -->
        <header id="main-header"> <!-- ヘッダーロゴ -->
            <div class="header-logo logo"> <a href="https://tsukunobi.com/"> <img
                        ...
                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/logo.png') }}" alt="ツクノビ">
                </a> </div>
            <div class="header-contact-wrapper"> <!-- 問い合わせボタン -->
                ...
                <div class="header-contact_tel"> <a href="tel:0365552078"> <span
                            ...
                            </svg> 03-6555-2078 </span> <span class="header-contact_tel--text2">平日10:00~19:00</span>
                    </a> </div>
            </div>
        </header> <!-- メイン -->
        <main id="new-main"><!-- MV -->
            <section class="mv top-mv heading">
                <div class="top-mv-inner"> <!-- 上半分 -->
                    <div class="mv-sp-bgimage">
                        <div class="mv-title-wrapper"> <!-- テキスト -->
                    ...
                    <div class="mv-request-wrapper">
                        <p class="mv-document-request_text"> ツクノビは、御社の代わりに<span>月間<span
                                    class="number">2000社</span></span>に<br class="u-mobile">営業する工事会社様向けサービスです </p>
                        <div class="mv-document-request-links"> <!-- 資料請求 -->
                            <div class="mv-document-request_link" style="margin: 0 auto;">
                            ...
                            <!-- 営業したい会社様はこちら --> <!-- </a> --> <!-- </div> --> <!-- </div> --> <!-- ーーーーー問い合わせ -->
                        </div>
                    </div> <!-- ーーーーー下半分 -->
                </div>
            </section><!-- 取引事例紹介 -->
            <section class="example top-example heading"> <!-- タイトル -->
                ...
                <div class="example-inner inner media-list">
                    ...
                    <div class="example-success-contents">
                        ...
                        <div class="example-success-after_list example-success-list">
                            ...
                            <ul class="introduce-campany_lists" style="display: flex; padding: 2rem; padding-top: 1rem;">
                                <li class="media-img"><img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/media_logo_1.png') }}"
                                        alt="USEN様" loading="lazy"></li>
                                <li class="media-img"><img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/media_logo_2.png') }}"
                                        alt="Daiwa Net様" loading="lazy"></li>
                                <li class="media-img"><img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/media_logo_3.png') }}"
                                        alt="air株式会社様" loading="lazy"></li>
                                <li class="media-img"><img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/media_logo_4.png') }}"
                                        alt="I-TEC様" loading="lazy"></li>
                                <li class="media-img"><img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/media_logo_5.png') }}"
            ...
            <section class="introduce top-introduce heading" style="padding-top: 0; padding-bottom: 0;"> <!-- タイトル -->
                <div class="introduce_banner introduce-banner">
                    <h4 class="introduce-banner_text"> ツクノビは、御社の代わりに<span>月間<span
                                class="number">2000</span>社</span>に営業する<br>返金の条件については別途お問い合わせください </h4>
                    <h4 class="introduce-banner_text"> 工事会社様向けサービスです。 </h4>
                </div>
            </section><!-- 中間テキストバナー -->
            <section class="reason top-reason heading"> <!-- 上半分 -->
                ...
                <h3 class="banner-set_title"> <br> 建築・建設業界特化の営業代行サービス<span>営業丸投げで売上が上がる</span><br> 建築・建設業界特化の営業代行サービス<span>営業丸投げで売上が <br> 業界特化の営業代行サービス<span>営業丸投げで売上が </h3>
                <div class="reason-top-wrapper" style="padding-top: 3rem;">
                    <div class="reason-top-inner"> <!-- タイトル -->
                        <div class="reason-top-title-wrapper">
                            <p> 業界に合わせてフォーム営業に限らずテレアポや<br> 手紙など様々な営業手法を検討します。 </p>
                        </div>
                        <div class="" style="padding-top: 4rem;">
                            <div class="">
                                <div class=""> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_1.png') }}"
                                        alt="探しています" class="u-desktop-flex" loading="lazy"> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/SP/img/illust_1.png') }}"
                ...
                <div class="reason-bottom-wrapper">
                    <div class="reason-bottom-inner inner"> <!-- タイトル -->
                        <div class="reason-bottom_title"> <img
                                src="{{ asset('assets/img/tsukubnobi/komon/PC/img/hukidasi_nayami.png') }}"
                        ...
                        <div class="reason-bottom-item-flexbox"> <!-- ① -->
                            <div class="reason-bottom_item reason-bottom_item--1">
                                <div class="reason-bottom-item_title">
                                    <h5>理由</h5> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/nayami_1.png') }}"
                                        alt="❶" loading="lazy">
                                </div>
                                <div class="reason-bottom-item_content">
                                    <div class="reason-bottom_image"> <img
                                            src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_2_1.png') }}"
                            ...
                            <div class="reason-bottom_item reason-bottom_item--2">
                                <div class="reason-bottom-item_title">
                                    <h5>理由</h5> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/nayami_2.png') }}"
                                        alt="❷" loading="lazy">
                                </div>
                                <div class="reason-bottom-item_content">
                                    <div class="reason-bottom_image"> <img
                                            src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_2_2.png') }}"
                            ...
                            <div class="reason-bottom_item reason-bottom_item--3">
                                <div class="reason-bottom-item_title">
                                    <h5>理由</h5> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/nayami_3.png') }}"
                                        alt="❸" loading="lazy">
                                </div>
                                <div class="reason-bottom-item_content">
                                    <div class="reason-bottom_image"> <img
                                            src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_2_3.png') }}"
            ...
            <section class="solution top-solution heading"> <!-- タイトル -->
                <div class="solution_title-wrapper section-title-wrapper">
                    <h4 class="section-title"> そんなお悩みを、ツクノビで解決 </h4> <span class="section-title_border"></span>
                </div>
                <div class="solution-inner inner">
                    <div class="solution-contents-wrapper"> <!-- ① -->
                        <div class="solution-items solution-item--1">
                            <div class="solution-item-text">
                                <div class="solution-item_tag"> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/hukidasi_kaiketu_1.png') }}"
                                        alt="解決１" loading="lazy">
                                    <p>最適な営業手法がわからない</p>
                                </div>
                                <div class="solution-item_title">
                                    <h3> ツクノビが<span>自社にあった<br> 営業手法を企画</span>します </h3>
                                </div>
                                <div class="solution-item_letter">
                                    <p> 業界に合わせてフォーム営業に限らずテレアポや<br> 手紙など様々な営業手法を検討します。 </p>
                                </div>
                            </div>
                            <div class="solution-item-image"> <img
                                    src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_3_1.png') }}"
                                    alt="企画します" loading="lazy"> </div>
                        </div> <!-- ーーーーーー --> <!-- ② -->
                        <div class="solution-items solution-item--2">
                            <div class="solution-item-text">
                                <div class="solution-item_tag"> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/hukidasi_kaiketu_2.png') }}"
                                        alt="解決２" class="u-desktop" loading="lazy"> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/SP/img/hukidasi_kaiketu_2.png') }}"
                                        alt="解決２" class="u-mobile" loading="lazy">
                                    <p>営業に割く時間がない</p>
                                </div>
                                <div class="solution-item_title">
                                    <h3> ツクノビが<span>営業リソース</span>を<br> 提供します </h3>
                                </div>
                                <div class="solution-item_letter">
                                    <p> 営業人材を1から採用するよりもコストを抑え、<br> 売上を上げることが可能です。 </p>
                                </div>
                            </div>
                            <div class="solution-item-image"> <img
                                    src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_3_2.png') }}"
                                    alt="提供します" loading="lazy"> </div>
                        </div> <!-- ーーーーーー --> <!-- ③ -->
                        <div class="solution-items solution-item--3">
                            <div class="solution-item-text">
                                <div class="solution-item_tag"> <img
                                        src="{{ asset('assets/img/tsukubnobi/komon/PC/img/hukidasi_kaiketu_3.png') }}"
                                        alt="解決３" loading="lazy">
                                    <p>営業が苦手</p>
                                </div>
                                <div class="solution-item_title">
                                    <h3> ツクノビが責任をもって<br> <span>営業を実行</span>します </h3>
                                </div>
                                <div class="solution-item_letter">
                                    <p> 営業が苦手な場合も問題ございません。<br class="u-mobile">営業リストの<br class="u-desktop"> 確認のみで、<br
                                            class="u-mobile">ツクノビが商談/見積り依頼を手配します。 </p>
                                </div>
                            </div>
                            <div class="solution-item-image"> <img
                                    src="{{ asset('assets/img/tsukubnobi/komon/PC/img/illust_3_3.png') }}"
            ...
            <section class="comparison top-comparison heading">
                <div class="comparison-inner"> <!-- タイトル -->
                    <div class="comparison-title">
                        ...
                        <h3 class="u-mobile"> <span>他社に負けない営業代行サービス</span>を </h3> <br>
                        <h3 class="u-mobile"> 磨いてまいりました </h3>
                    </div>
                    <div class="can_scroll u-mobile can_scroll--1">
                        <p>スクロール可能です</p> <img
                            src="https://tsukunobi.com/sys/wp-content/themes/sango-theme/img/top/scroll.png" alt="→"
                            loading="lazy">
                    </div> <!-- テーブル -->
                    ...
                    <div class="can_scroll u-mobile can_scroll--2">
                        <p>スクロール可能です</p> <img
                            src="https://tsukunobi.com/sys/wp-content/themes/sango-theme/img/top/scroll.png" alt="→"
                            loading="lazy">
                    </div>
            ...
            <section class="refund top-refund heading">
                <div class="refund_text-banner">
                    <h4>安心してご利用いただけるように返金保証制度を用意</h4>
                </div>
                <div class="refund-inner inner">
                    <div class="refund_image"> <img
                            src="https://tsukunobi.com/sys/wp-content/themes/sango-theme/img/top/henkin.png"
                            alt="満足いかなければ全額返金" loading="lazy"> </div>
                    <div class="refund_text">
                        <h3> ツクノビによる営業支援によって、<br> 営業結果が出なかった場合には<br> サービス利用料を全額返金いたします。 </h3>
                        <p>※返金の条件については別途お問い合わせください</p>
                    </div>
                </div>
            </section><!-- 導入企業 -->
            ...
            <section class="question top-question heading"> <!-- タイトル -->
                ...
                <div class="question-inner inner"> <!-- 内容 -->
                    <ul class="accordion-area"> <!-- ① -->
                        <li>
                            <section>
                                <h3 class="title">ツクノビの業務範囲はどこまでですか？<br class="u-mobile">また業務外はありますか？</h3>
                                <div class="box">
                                    <p> 基本的プランは営業企画~商談実施までの範囲で、メールの確認や受電対応も実施させていただきます。ご要望に応じてカスタマイズも可能でございますので、お気軽にご相談くださいませ。
                                    </p>
                                </div>
                            </section>
                        </li> <!-- ② -->
                        <li>
                            <section>
                                <h3 class="title">一般顧客向けの営業はやっていますか？</h3>
                                <div class="box">
                                    <p> 誠に恐れ入りますが、飛び込みなどの一般顧客向けの営業は行っておりません。一般顧客向けの施策についてはwebマーケティング施策をご提案させていただくことが可能です。
                                    </p>
                                </div>
                            </section>
                        </li> <!-- ③ -->
                        <li>
                            <section>
                                <h3 class="title">どのような業種の<br class="u-mobile">クライアントが多いですか？</h3>
                                <div class="box">
                                    <p> 内装や設備、土木など幅広いお客様にご利用いただいております。 </p>
                                </div>
                            </section>
                        </li> <!-- ④ -->
                        <li>
                            <section>
                                <h3 class="title">返金制度はありますか？</h3>
                                <div class="box">
                                    <p> 営業効果に満足いただけない場合、全額返金させていただきます。 </p>
                                </div>
                            </section>
                        </li> <!-- ⑤ -->
                        <li>
                            <section>
                                <h3 class="title">1ヶ月だけのスポットでの利用は<br class="u-mobile">可能でしょうか？</h3>
                                <div class="box">
                                    <p> 誠に恐れ入りますが、契約期間は最低6ヶ月となり、スポットでの対応は行っておりません。 </p>
                                </div>
                            </section>
                        </li> <!-- ⑥ -->
                        <li>
                            <section>
                                <h3 class="title">解約したい場合はどうなりますか？</h3>
                                <div class="box">
                                    <p> 残りの契約金額を精算することで解約が可能です。 </p>
                                </div>
                            </section>
                        </li>
                    </ul>
            ...
            <section id="go-contact" class="contact top-contact heading">
                <div class="contact-title-wrapper">
                    <h3>営業丸投げで売上が上がる</h3>
                    <h2>建築･建設業界特化の営業代行サービス</h2>
                </div>
                <div class="contact_30s-image"> <img
                        src="https://tsukunobi.com/sys/wp-content/themes/sango-theme/img/top/hukidasi_30sec.png"
                        alt="30秒で入力完了!" loading="lazy"> </div>
                <div class="contact-form-inner contact_form-inner">
                    <div action="confirm.php" method="post" name="form" onsubmit="return validate()">
                        <h4 class="contact-form_title"> 営業丸投げで案件獲得を実現するツクノビ<br> まずは資料をご請求下さい。 </h4>
                        <div class="wpcf7 no-js" id="wpcf7-f6486-o1" lang="ja" dir="ltr">
                            <div class="screen-reader-response">
                                <p role="status" aria-live="polite" aria-atomic="true"></p>
                                <ul></ul>
                            </div>
                            <form action="/#wpcf7-f6486-o1" method="post" class="wpcf7-form init" aria-label="コンタクトフォーム"
                                novalidate="novalidate" data-status="init">
                                <div style="display: none;"><input type="hidden" name="_wpcf7" value="6486" /><input
                                        type="hidden" name="_wpcf7_version" value="5.7.7" /><input type="hidden"
                                        name="_wpcf7_locale" value="ja" /><input type="hidden" name="_wpcf7_unit_tag"
                                        value="wpcf7-f6486-o1" /><input type="hidden" name="_wpcf7_container_post"
                                        value="0" /><input type="hidden" name="_wpcf7_posted_data_hash"
                                        value="" /><input type="hidden" name="_wpcf7_recaptcha_response" value="" />
                                </div>
                                <p><label class="form_label-title"><br />お問い合わせ内容:<span
                                            class="red">必須</span><br /></label><br /><span
                                        class="wpcf7-form-control-wrap" data-name="category"><span
                                            class="wpcf7-form-control wpcf7-radio radio_button"><span
                                                class="wpcf7-list-item first"><input type="radio" name="category"
                                                    value="サービスについて聞きたい" checked="checked" /><span
                                                    class="wpcf7-list-item-label">サービスについて聞きたい</span></span><span
                                                class="wpcf7-list-item"><input type="radio" name="category"
                                                    value="営業提案を受けたい" /><span
                                                    class="wpcf7-list-item-label">営業提案を受けたい</span></span><span
                                                class="wpcf7-list-item"><input type="radio" name="category"
                                                    value="資料が見たい" /><span
                                                    class="wpcf7-list-item-label">資料が見たい</span></span><span
                                                class="wpcf7-list-item last"><input type="radio" name="category"
                                                    value="その他" /><span
                                                    class="wpcf7-list-item-label">その他</span></span></span></span></p>
                                <p><label class="form_label-title"><br />お名前:<span
                                            class="red">必須</span><br /></label><br /><span
                                        class="wpcf7-form-control-wrap" data-name="your-name"><input size="40"
                                            class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                            aria-required="true" aria-invalid="false" placeholder="例）山田　太郎" value=""
                                            type="text" name="your-name" /></span></p>
                                <p><label class="form_label-title"><br />貴社名:<span
                                            class="red">必須</span><br /></label><br /><span
                                        class="wpcf7-form-control-wrap" data-name="company"><input size="40"
                                            class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                            aria-required="true" aria-invalid="false" placeholder="例）株式会社ツクノビ" value=""
                                            type="text" name="company" /></span></p>
                                <p><label class="form_label-title"><br />住所:<span
                                            class="red">必須</span><br /></label><br /><span
                                        class="wpcf7-form-control-wrap" data-name="address"><input size="40"
                                            class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                            aria-required="true" aria-invalid="false"
                                            placeholder="例）東京都渋谷区上原00-00 ◯◯ビル1階" value="" type="text"
                                            name="address" /></span></p>
                                <p><label class="form_label-title"><br />メールアドレス:<span
                                            class="red">必須</span><br /></label><br /><span
                                        class="wpcf7-form-control-wrap" data-name="email"><input size="40"
                                            class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"
                                            aria-required="true" aria-invalid="false"
                                            placeholder="例）example@tsukunobi.co.jp" value="" type="email"
                                            name="email" /></span></p>
                                <p><label class="form_label-title"><br />電話番号:<span
                                            class="red">必須</span><br /></label><br /><span
                                        class="wpcf7-form-control-wrap" data-name="tel"><input size="40"
                                            class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel"
                                            aria-required="true" aria-invalid="false" placeholder="例）03-1234-5678"
                                            value="" type="tel" name="tel" /></span></p>
                                <p><input class="wpcf7-form-control has-spinner wpcf7-submit contact_btn" type="submit"
                                        value="資料請求する" /></p>
                                <p>
                                    <script>document.addEventListener('wpcf7mailsent', function (event) {
                                            location = 'https://tsukunobi.com/tsukunobi/complete';
                                        }, false);</script>
                                </p>
            ...
            <section class="the-bottom top-the-bottom inner heading" id="">
                <div class="the-bottom-text">
                    <h4>お客様のお悩み･課題に合わせた活用方法を<br class="u-mobile">ご提案いたします。</h4>
                    <p>専門のスタッフが課題に合わせて対応いたします。<br class="u-mobile">まずはお気軽にお問い合わせください。</p>
                </div>
                <div class="the-bottom_tel-btn new-blue-btn btn"> <a href="tel:0365552078">
                        <div class="tel-number number"> <svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                <path
                                    d="M280 0C408.1 0 512 103.9 512 232c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-101.6-82.4-184-184-184c-13.3 0-24-10.7-24-24s10.7-24 24-24zm8 192a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm-32-72c0-13.3 10.7-24 24-24c75.1 0 136 60.9 136 136c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-48.6-39.4-88-88-88c-13.3 0-24-10.7-24-24zM117.5 1.4c19.4-5.3 39.7 4.6 47.4 23.2l40 96c6.8 16.3 2.1 35.2-11.6 46.3L144 207.3c33.3 70.4 90.3 127.4 160.7 160.7L345 318.7c11.2-13.7 30-18.4 46.3-11.6l96 40c18.6 7.7 28.5 28 23.2 47.4l-24 88C481.8 499.9 466 512 448 512C200.6 512 0 311.4 0 64C0 46 12.1 30.2 29.5 25.4l88-24z" />
                            </svg>
                        ...
                        <div class="business-hour">
                            <p class="business-hour--1">月〜金<br class="u-desktop"></p>
                            <p class="business-hour--2">10:00~19:00</p>
                        </div>
                    </a> </div>
            </section>
        </main><!-- フッター -->
        <footer class="footer--1">
            <div class="footer-inner"> <!-- 左側 -->
                <section class="footer-info-wrapper">
                    <div class="footer-logo logo"> <a href="https://tsukunobi.com/"> <svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1158.36 271.18">
                                <defs>
                                    <style>
                                        .d {
                                            fill: #fff;
                                ...
                                <g id="b">
                                    <g id="c">
                                        <g>
                                            <polygon class="d"
                                                points="199.96 166.53 159.01 166.53 159.01 28.93 199.96 0 199.96 166.53">
                                            </polygon>
                                            <polygon class="d"
                                                points="118.14 166.53 76.48 166.53 76.48 86.82 118.14 50.66 118.14 166.53">
                                            </polygon>
                                            <polygon class="d"
                                                points="42.15 171.59 0 171.59 0 131.9 42.15 95.74 42.15 171.59">
                                            </polygon>
                                            <polygon class="d"
                                                points="22.79 235.9 42.15 225.27 158.93 196.84 158.93 160.19 199.96 160.19 199.96 197.82 22.79 271.18 22.79 235.9">
                                            </polygon>
                                        </g>
                                        <g>
                                            <path class="d"
                                                d="M300.32,166.48l38.75-95.85h37.98l-38.76,95.85h-37.98Zm57.62,0l38.75-95.85h37.72l-38.5,95.85h-37.98Zm32.29,85l62.27-154.24h57.36l-62.27,154.24h-57.36Z">
                                            </path>
                                            <path class="d"
                                                d="M518.39,156.14l33.33-85.52h171.81l-73.12,180.85h-57.36l62.27-154.24h-56.32l-23.25,58.91h-57.36Z">
                                            </path>
                                            <path class="d"
                                                d="M681.42,251.48l10.85-26.61h30.49l111.35-154.24h65.88l-130.73,180.85h-87.84Z">
                                            </path>
                                            <path class="d"
                                                d="M931,70.62h57.62l-10.85,26.61h97.66l-5.17,12.92h57.62l-5.43,13.69h-155.53l-29.97,74.41h155.54l-21.7,53.22h-212.89l73.12-180.85Zm177.75,33.85l13.69-33.85h-28.68l-13.95,33.85h28.94Zm35.91,0l13.69-33.85h-28.68l-13.95,33.85h28.94Z">
                                            </path>
                                        </g>
                                    </g>
                                </g>
                    ...
                    <ul class="footer-info">
                        <li class="footer-info_item">株式会社NITACO</li>
                        <li class="footer-info_item">東京都渋谷区道玄坂１丁目１６−６ 二葉ビル 8b</li>
                        <li class="footer-info_item">TEL: 03-6555-2072</li>
                    </ul>
                </section> <!-- 右側 -->
                <section class="footer-nav-wrapper">
                    <ul class="footer-nav">
                        <li class="footer-nav_item"><a href="https://tsukunobi.com/">サービス紹介</a></li>
                        <li class="footer-nav_item"><a href="https://tsukunobi.com/columns/">お役立ち情報</a></li>
                        <li class="footer-nav_item"><a href="https://tsukunobi.com/company/">運営会社</a></li>
                        <li class="footer-nav_item"><a href="https://tsukunobi.com/contact/">お問い合わせ</a></li>
                        <li class="footer-nav_item"><a href="https://tsukunobi.com/privacy-policy/">プライバシーポリシー</a></li>
                    </ul>
                </section>
            </div>
            <p class="footer-copyright">Copyright &copy; 2023 tsukunobi.com</p>
        </footer><!-- 終了 --><!-- js slick -->
        ...
        <!-- wordpressになったら、「type="text/javaScript" charset="utf-8"」を追加し、headタグ内へ -->
        <script src="https://tsukunobi.com/sys/wp-content/themes/sango-theme/js/script.js"></script>
    ...
    /* ]]> */</script>
        ...
        <script type='text/javascript' id='contact-form-7-js-extra'>/* <![CDATA[ */
            var wpcf7 = { "api": { "root": "https:\/\/tsukunobi.com\/wp-json\/", "namespace": "contact-form-7\/v1" }, "cached": "1" };
    /* ]]> */</script>
        <script type='text/javascript'
    ...
    /* ]]> */</script> -->
        ...
        <script type='text/javascript'
            src='https://tsukunobi.com/sys/wp-content/plugins/ultimate-addons-for-gutenberg/assets/js/imagesloaded.min.js'
            id='uagb-imagesloaded-js'></script>
        <script type='text/javascript'
            src='https://tsukunobi.com/sys/wp-content/plugins/ultimate-addons-for-gutenberg/assets/js/slick.min.js'
            id='uagb-slick-js-js'></script>
        <script type='text/javascript'
            src='https://www.google.com/recaptcha/api.js?render=6LdgwY4kAAAAANPvvMcEDYtAjkl0jLq2fZVlvz3k'
            id='google-recaptcha-js'></script>
        <script type='text/javascript'
            src='https://tsukunobi.com/sys/wp-includes/js/dist/vendor/wp-polyfill-inert.min.js?ver=3.1.2'
            id='wp-polyfill-inert-js'></script>
        <script type='text/javascript'
            src='https://tsukunobi.com/sys/wp-includes/js/dist/vendor/regenerator-runtime.min.js?ver=0.13.11'
            id='regenerator-runtime-js'></script>
        <script type='text/javascript'
            src='https://tsukunobi.com/sys/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=3.15.0'
    ...
    /* ]]> */</script> -->
        ...
        <!-- <script>const sng = {}; sng.domReady = (fn) => { document.addEventListener("DOMContentLoaded", fn); if (document.readyState === "interactive" || document.readyState === "complete") { fn(); } }; sng.fadeIn = (el, display = "block") => {
                ...
                el.classList.remove('active'); function fadeOutAnimationEnd() { el.classList.remove(display); el.removeEventListener('transitionend', fadeOutAnimationEnd); }; el.addEventListener('transitionend', fadeOutAnimationEnd);
            }; sng.offsetTop = (el) => { const rect = el.getBoundingClientRect(); const scrollTop = window.pageYOffset || document.documentElement.scrollTop; const top = rect.top + scrollTop; return top }; sng.wrapElement = (el, wrapper) => { el.parentNode.insertBefore(wrapper, el); wrapper.appendChild(el); }; sng.scrollTop = () => { return window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0; }; const elements = document.querySelectorAll('.entry-content [data-type="script"], .entry-content iframe'); const io = new IntersectionObserver(function (entries) {
                entries.forEach(function (entry) {
                    if (entry.isIntersecting) {
                        const element = entry.target; if (element.classList.contains('executed')) { return; }
