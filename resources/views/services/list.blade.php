                    ...
                    <tr>
                      ...
                      <th style="min-width: 90px;">
                        <a href="{{route('add_service')}}">
                          <span class="text-primary" data-bs-target="#categoryModal">
                  ...
                  <tbody id="item-table-body">
                    ...
                    <tr id={{ "service". $service->id }}>
                      ...
                      <td style="min-width: 90px;">
                        <span data-category={{ $service }} data-bs-toggle="modal" data-bs-target="#categoryModal">
                          <i class='bx bxs-edit text-primary'></i>
                        </span>
                        <span data-id={{ $service->id }} data-bs-toggle="modal" data-bs-target="#confirmModal">
