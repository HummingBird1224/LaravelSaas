			...
			<div class="layout-container">
				...
				<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
					...
					<ul class="menu-inner py-1">
						...
						<li <?php if (strpos(url()->current(), "mypage/reputation_answers")) echo 'class="menu-item active open"';
								else echo 'class="menu-item"'; ?>>
						...
						<li <?php if (strpos(url()->current(), "mypage/requested_materials")) echo 'class="menu-item active open"';
								else echo 'class="menu-item"'; ?>>
						...
						<li <?php if (strpos(url()->current(), "client/dashboard")) echo 'class="menu-item active"';
								else echo 'class="menu-item"'; ?>>
