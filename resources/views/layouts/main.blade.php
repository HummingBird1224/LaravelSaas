...
<body>
  ...
  <div class="layout-wrapper layout-content-navbar">
    <div class="layout-container mypage">
      <!-- Menu -->
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li <?php if (str_ends_with(url()->current(), "mypage")) echo 'class="menu-item active"';
								else echo 'class="menu-item"'; ?>>
          ...
          <li <?php if (strpos(url()->current(), "mypage/reputation_answers")) echo 'class="menu-item active "';
								else echo 'class="menu-item"'; ?>>
            <a href="{{ route('reputation_answers') }}" class="menu-link ">
              <i class='menu-icon tf-icons bx bx-message-rounded'></i>
              <div>投稿した口コミ</div>
            </a>
          </li>

          <li <?php if (strrpos(url()->current(), "mypage/requested_materials")) echo 'class="menu-item active "';
								else echo 'class="menu-item"'; ?>>
