    ...
    <div class="layout-container admin">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li <?php if (strpos(url()->current(), "admin/service_activities")) echo 'class="menu-item active "';
								else echo 'class="menu-item"'; ?>>
            <a href="{{ route('admin_service_activities') }}" class="menu-link">
              <i class='menu-icon tf-icons bx bx-download'></i>
              <div>サービス活動</div>
            </a>
          </li>

          <li <?php if (strpos(url()->current(), "admin/category_issues")) echo 'class="menu-item active"';
								else echo 'class="menu-item"'; ?>>
            <a href="{{ route('admin_category_issues') }}" class="menu-link">
