...
<head> <!-- Google Tag Manager -->
    ...
    <!-- <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-MH99Z2M');</script>
    ...
    <div id="container"> <!-- ヘッダー -->
        ...
        <main id="new-main"><!-- MV -->
                ...
                <div class="example-inner inner">
                    <div class="example-sub-contents">
                        ...
                        <div class="example_sub-image"> <img
                                src="{{ asset('assets/img/tsukubnobi/web/PC/img/graph.png') }}"
            ...
            <section class="reputation top-reputation heading"> <!-- タイトル -->
                ...
                <div class="reputation-inner-wrapper" id="more-content">
                    <div class="reputation-inner more-inner inner"> <!-- 写真＋タイトル -->
                        <div class="reputation-contents-title">
                            <div class="reputation-content_image"> <img
                                    src="https://tsukunobi.com/sys/wp-content/themes/sango-theme/img/top/voice_image_1.jpg"
                                    alt="株式会社アイル様" loading="lazy"> </div>
                            <div class="reputation-content_text">
                                <h3 class="reputation-content_text-title"> かつて課題に感じていた部分が<br> 全て解決すると同時に、<br>
                                    成果に結びつきました。 </h3>
                                <div class="reputation-content_banner company-banner"> 株式会社アイル様（内装業） </div>
                            </div>
                        </div>
                        <div class="container">
                            <p class="container-text"> ツクノビ導入前は、営業を何人も採っていましたが辞めてしまい、定着しない状況が続いていました。<br
                                    class="u-mobile">ツクノビは営業の採用コストを考えると、値段がリーズナブルだと感じました。<br>
                                プレゼンもよかったので試しに使ってみようと思いました。ただDMを流すという会社はたくさんあると思うんですけど、サポートとかアポイントの獲得とかフォローアップの部分があったので、そういうところが信頼できた部分ですね。
                            </p> <button class="more-btn">もっと見る</button>
                        </div>
                    </div>
                </div>
            </section><!-- ツクノビとは？ -->
            <section class="introduce top-introduce heading"> <!-- タイトル -->
                ...
                <div class="introduce_banner introduce-banner">
                    <h4 class="introduce-banner_text"> ツクノビは、御社の代わりに<span>月間<span
                                class="number">2000</span>社</span>に営業する<br> </h4>
                ...
                <div class="banner-set-wrapper">
                    ...
                    <div class="banner-set-links">
                        <div class="document-request_link">
                            ...
                            <div class="red-btn btn document_request-btn document_request-btn--red custom_btn"> <a
                                    href="#go-contact">資料請求</a> </div>
                        </div>
                ...
                <div class="reason-bottom-wrapper">
                    <div class="reason-bottom-inner inner"> <!-- タイトル -->
                        <div class="reason-bottom_title"> <img
                                src="{{ asset('assets/img/tsukubnobi/web/PC/img/hukidasi_nayami.png') }}"
                        ...
                        <div class="reason-bottom-item-flexbox"> <!-- ① -->
                            <div class="reason-bottom_item reason-bottom_item--1">
                                <div class="reason-bottom-item_title">
                                    <h5>理由</h5> <img
                                        src="{{ asset('assets/img/tsukubnobi/web/PC/img/nayami_1.png') }}"
                                        alt="❶" loading="lazy">
                                </div>
                                <div class="reason-bottom-item_content">
                                    <div class="reason-bottom_image"> <img
                                            src="{{ asset('assets/img/tsukubnobi/web/PC/img/illust_1_1.png') }}"
                                            alt="わからない" loading="lazy"> </div>
                                    <p class="reason-bottom_text" style="line-height: normal;"> 最適な営業手法がわからない </p>
                                </div>
                            </div> <!-- ーーーーー --> <!-- ② -->
                            <div class="reason-bottom_item reason-bottom_item--2">
                                <div class="reason-bottom-item_title">
                                    <h5>理由</h5> <img
                                        src="{{ asset('assets/img/tsukubnobi/web/PC/img/nayami_2.png') }}"
                                        alt="❷" loading="lazy">
                                </div>
                                <div class="reason-bottom-item_content">
                                    <div class="reason-bottom_image"> <img
                                            src="{{ asset('assets/img/tsukubnobi/web/PC/img/illust_1_2.png') }}"
                            ...
                            <div class="reason-bottom_item reason-bottom_item--3">
                                <div class="reason-bottom-item_title">
                                    <h5>理由</h5> <img
                                        src="{{ asset('assets/img/tsukubnobi/web/PC/img/nayami_3.png') }}"
                                        alt="❸" loading="lazy">
                                </div>
                                <div class="reason-bottom-item_content">
                                    <div class="reason-bottom_image"> <img
                                            src="{{ asset('assets/img/tsukubnobi/web/PC/img/illust_1_3.png') }}"
                ...
                <div class="solution-inner inner">
                    <div class="solution-contents-wrapper"> <!-- ① -->
                        <div class="solution-items solution-item--1">
                            <div class="solution-item-text">
                                <div class="solution-item_tag"> <img
                                        src="{{ asset('assets/img/tsukubnobi/web/PC/img/hukidasi_kaiketu_1.png') }}"
                            ...
                            <div class="solution-item-image"> <img
                                    src="{{ asset('assets/img/tsukubnobi/web/PC/img/illust_2_1.png') }}"
                        ...
                        <div class="solution-items solution-item--2">
                            ...
                            <div class="solution-item-image"> <img
                                    src="{{ asset('assets/img/tsukubnobi/web/PC/img/illust_2_2.png') }}"
                                    alt="提供します" loading="lazy"> </div>
                        </div> <!-- ーーーーーー --> <!-- ③ -->
                        <div class="solution-items solution-item--3">
                            <div class="solution-item-text">
                                <div class="solution-item_tag"> <img
                                        src="{{ asset('assets/img/tsukubnobi/web/PC/img/hukidasi_kaiketu_3.png') }}"
                            ...
                            <div class="solution-item-image"> <img
                                    src="{{ asset('assets/img/tsukubnobi/web/PC/img/illust_2_3.png') }}"
